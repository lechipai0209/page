      ...
      },
      {
        ...
        detailedContent: {
          paragraphs: [
            ...
            "Express.js was the first server framework I encountered, and I struggled to understand JavaScript's event loop. I referenced many resources and thought about how someone who had never learned programming could understand the event loop. I believe the best approach is to:",
...
console.log("haha");`,
      ...
      },
      {
        ...
        highlights: [
          ...
          "Implemented serverless backend design using JWT authentication and Google Auth for quick user login.",
          ...
          sections: [
            ...
            },
            {
              ...
              content: [
                ...
                "**Server State**: This project adopts serverless server configuration. The server doesn't need to separately record user state information, only needing JWT tokens to identify users logged in through Google Auth.",
      ...
      },
      {
        ...
        detailedContent: {
          paragraphs: [
            ...
            "express.js 是我第一個接觸到的server框架，非常不理解 javascript的event loop。我參考許多資料，並思考如果是從來沒學過程式語言的人要如何理解event loop。我認為最佳的方式就是",
            "1. **描述相關事件來提供完整脈絡**\n2. **以例子和視圖來帶入情境**",
...
console.log("haha");`,
      ...
      },
      {
        ...
        highlights: [
          ...
          "透過 JWT 身分驗證實現後端 serverless 設計，並使用 Google Auth 讓使用者快速登入",
          ...
          sections: [
            ...
            },
            {
              ...
              content: [
                ...
                "**伺服器狀態**：本專案採用 serverless 的伺服器設定，伺服器不需要另外記錄使用者的狀態資訊，僅需要透過 JWT token 來辨識透過 Google Auth 登入者的身分。",
